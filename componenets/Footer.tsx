...
export const Footer: React.FC = () => {
  return (
    <footer className="grid h-fit grid-cols-1 gap-4 bg-gray-900 p-6 text-white md:grid-cols-3 lg:px-12">
      {/* Left Side - Developer Profile */}
      <div className="col-span-1">
        <div className="flex-row">
          <motion.div
            className="e-card playing relative overflow-hidden"
          ...
          >
            ...
            >
              ...
              <div className="p-2 text-2xl uppercase font-sans font-bold text-white">
                Ali Ghorbani
              </div>
            </div>
      ...
      {/* Right Side - Compact Contact Section */}
      <div className="md:col-span-2">
        <motion.div
          className="h-full rounded-2xl border border-purple-500/20 bg-gradient-to-br from-gray-800 to-gray-900 p-6 backdrop-blur-lg"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        >
          <h2 className="font-rezvan mb-6 text-2xl text-purple-400/90">
          ...
          <div className="space-y-5">
            ...
            >
              <div className="relative h-9 w-9 shrink-0">
                <div className="animate-pulse-slow absolute inset-0 rounded-full bg-purple-500/20"></div>
                <div className="relative flex h-full w-full items-center justify-center rounded-full bg-purple-500/10">
                  <svg
              ...
              <div>
                ...
                <p className="font-sans font-medium tracking-wide text-gray-300">
                  ۰۹۱۲ xxx xxxx
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="relative h-9 w-9 shrink-0">
                <div className="animate-pulse-slow absolute inset-0 rounded-full bg-blue-500/20"></div>
                <div className="relative flex h-full w-full items-center justify-center rounded-full bg-blue-500/10">
                  <svg
            ...
            >
              <div className="relative h-9 w-9 shrink-0">
                <div className="animate-pulse-slow absolute inset-0 rounded-full bg-pink-500/20"></div>
                <div className="relative flex h-full w-full items-center justify-center rounded-full bg-pink-500/10">
                  <svg
              ...
              <div>
                ...
                <p className="font-rezvan text-sm leading-tight text-gray-300">
                  کرج، شاهین ویلا
                  <br />
          ...
          <div className="mt-6 flex items-center justify-between border-t border-purple-500/10 pt-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-gray-400">نسخه نمایشی</span>
            </div>
            <div className="flex gap-2">
              <motion.div
                className="h-2 w-2 rounded-full bg-purple-500/30"
              ...
              />
              <motion.div
                className="h-2 w-2 rounded-full bg-pink-500/30"
                animate={{ scale: [1, 1.2, 1] }}
